...
```bash
ros2 action send_goal /easy_handeye2/calibration/take_multiple_samples easy_handeye2_msgs/action/TakeMultipleSamples "{sample_frequency: 1.0, max_duration: 5.0, max_samples: 7, defer_action_time: 3.0, clear_samples_before: true, compute_calibration: true, save_calibration: true, save_samples: true}"
```
